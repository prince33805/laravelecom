    <div class="content-wrapper">
            ...
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="text-muted font-weight-normal">Total Pending</h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-row justify-content-between">
                            <h4 class="card-title mb-1">Best Seller (Net Profit)</h4>
                            <p class="text-muted mb-1">$ Dollar</p>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="preview-list">
                                    @foreach ($bestsellerprofit as $product)
                                            ...
                                            <div class="preview-item-content d-sm-flex flex-grow">
                                                <div class="flex-grow">
                                                    <h6 class="preview-subject">
                                                        {{-- <p> id : {{$product->product_id}} name : </p> --}}
                                                        {{ $product->product_name }}</h6>
                                                    <p class="text-muted mb-0">profit : $ {{ $product->diff_price }}
                                                    </p>
                                                </div>
                                                <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                                    <p class="text">$ {{ $product->profit }}</p>
            ...
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-row justify-content-between">
                            <h4 class="card-title mb-1">Best Seller (Revenue)</h4>
                            <p class="text-muted mb-1">$ Dollar </p>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="preview-list">
                                    @foreach ($bestsellerrevenue as $product)
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
                                            ...
                                            <div class="preview-item-content d-sm-flex flex-grow">
                                                <div class="flex-grow">
                                                    ...
                                                    <p class="text-muted mb-0">price : $ {{ $product->priceperpiece }}
                                                    </p>
                                                </div>
                                                <div class="mr-auto text-sm-right pt-2 pt-sm-0">
            ...
            {{-- <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-row justify-content-between">
                            <h4 class="card-title mb-1">Best Seller (Quantity)</h4>
                            <p class="text-muted mb-1">Quantity</p>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="preview-list">
                                    @foreach ($bestsellerquantity as $product)
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
            ...
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-row justify-content-between">
                            <h4 class="card-title mb-1">Lowest Product Remaining</h4>
                            <p class="text-muted mb-1">Quantity</p>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="preview-list">
                                    @foreach ($lowest5product as $product)
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
                                            ...
                                            <div class="preview-item-content d-sm-flex flex-grow">
                                                ...
                                                <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                                    <p class="text">{{ $product->product_quantity }}</p>
        ...
        <div class="row">
            {{-- {{$chart}} --}}
            <div class="col-6">
                <div id="board1" style="height:450px;"></div>
            </div>
            <div class="col-6">
                <div id="board2" style="height:450px;"></div>
            </div>
        </div>
        ...
        {{-- <div class="row">
            <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-row justify-content-between">
                            <h4 class="card-title mb-1">Best Seller (Net Profit Margin %)</h4>
                            <p class="text-muted mb-1">%</p>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="preview-list">
                                    @foreach ($bestsellerprofitmargin as $product)
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
                                                <div class="preview-icon bg-success">
                                                    <i class="mdi mdi-file-document"></i>
                                            ...
                                            <div class="preview-item-content d-sm-flex flex-grow">
                                                <div class="flex-grow">
                                                    <h6 class="preview-subject">
                                                        {{ $product->product_name }}</h6>
                                                    <p class="text-muted mb-0">price : $ {{$product->product_price}} </p>
                                                </div>
                                                <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                                    <p class="text">{{ $product->margin }} %</p>
                                                    <p class="text-muted mb-0">buy price : $ {{$product->buy_price}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
